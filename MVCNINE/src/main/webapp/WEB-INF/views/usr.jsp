...
<div class="row-fluid">
	<div class="col-md-3 col-xs-12">
				<form:form action="/adminPanel/usr" class="form-inline" method="get" modelAttribute="filter">
				<custom:hiddenInputs excludeParams="roleIds, _roleIds" />
				<div>
					<h4>Roles</h4>
				</div>
				<div>
					<form:checkboxes items="${roles}" path="roleIds" itemLabel="role" itemValue="id"/>
				</div>
				<div>
	...
	<div class="col-md-7 col-xs-12">
			<form:form class="form-inline" action="/adminPanel/usr" method="post" modelAttribute="usr">
		<form:hidden path="id" />
		<custom:hiddenInputs excludeParams="username, password, email, role, id" />
